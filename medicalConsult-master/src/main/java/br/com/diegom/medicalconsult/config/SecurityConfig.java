package br.com.diegom.medicalconsult.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("DIEGO").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("GULIA").password(passwordEncoder.encode("12345")).roles("PACIENTE")
                .and()
                .withUser("MUCO").password(passwordEncoder.encode("12345")).roles("SECRETARIA");
