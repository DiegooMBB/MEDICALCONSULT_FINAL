package br.com.diegom.medicalconsult.usuario.services;

import br.com.diegom.medicalconsult.usuario.domain.Usuario;
import br.com.diegom.medicalconsult.usuario.repositories.UsuarioRepository;
...
class UsuarioServiceTest {
    ...
    void cadastrarUsuario() {
        ...
        assertEquals("diego", result.getNomeUsuario());
    ...
    void listarUsuarios() {
        ...
        assertAll(
                ...
                () -> assertEquals("gulia", resulta.get(1).getNomeUsuario())
        );
    }
    ...
    void buscarUsuario() {
        ...
        assertAll(
                ...
                () -> assertEquals("diego", resultado.getNomeUsuario())
        );
    }
